...
$(window).scroll(function (event) {
    ...
    if (st > lastScrollTop) {
        ...
        if (document.documentElement.scrollTop >= setPosition -100) {
            $(".hide-text").removeClass("fade-out");
          
            
        }

        if (document.documentElement.scrollTop >= setPosition -70) {
            $(".Animation-Text").css("display", "block");
            $(".Animation-Text").addClass("text-focus-in");
        ...
        if (document.documentElement.scrollTop <= setPosition) {
            if (scrolled >= 0 && scrolled <= 33) {
              setTimeout(() => {
                $(".Animation-Text").css("display", "none");
                  
              }, 500);


                document.getElementById("myBar").style.width = "0%";
                $(".hide-text").addClass("fade-out");
                $(".Animation-Text").removeClass("text-focus-in");
    ...
    if (st > lastScrollTop) {
        ...
        var stockImagePosition = 750;

        if (document.documentElement.scrollTop >= stockImagePosition) {
            $(".profitlevel1").removeClass("imageprofitTablet1");
                $(".profitlevel1").removeClass("imageprofitTablet2");
                $(".profitlevel1").removeClass("imageprofitTablet3");
    ...
    if (st > lastScrollTop) {
        var stockImagePosition = 850;

        if (document.documentElement.scrollTop >= stockImagePosition) {
            $(".stocks1").css("display", "block");
            $(".stocks1").addClass("imageStocksTablet1");
            ...
            setTimeout(() => {
                ...
                $(".stocks2").addClass("imageStocksTablet2");
            ...
            setTimeout(() => {
                ...
                $(".stocks3").addClass("imageStocksTablet3");
                $(".GOOG").css("display", "block");
                // }
            }, 400);
        }
    } else {
        var stockImagePosition = 855;
        if (document.documentElement.scrollTop <= stockImagePosition) {
            $(".stocks3").css("display", "none");
            $(".stocks3").removeClass("imageStocksTablet3");
            $(".GOOG").css("display", "none");
            setTimeout(() => {
                // if (document.documentElement.scrollTop <= stockImagePosition - 20) {
                $(".stocks2").css("display", "none");
                $(".stocks2").removeClass("imageStocksTablet2");
            ...
            setTimeout(() => {
                ...
                $(".stocks1").removeClass("imageStocksTablet1");
    ...
    if (st > lastScrollTop) {
        ...
        if (document.documentElement.scrollTop >= stockImagePosition) {
            ...
            setTimeout(() => {
                ...
                $(".Crypto2").addClass("imageCryptoTable2");
            ...
            setTimeout(() => {
                ...
                $(".Crypto3").addClass("imageCryptoTable3");
        ...
        var stockImagePosition = 930
        if (document.documentElement.scrollTop <= stockImagePosition) {
            $(".Crypto3").css("display", "none");
            $(".Crypto3").removeClass("imageCryptoTable3");
            $(".ETHEREUM").css("display", "none");
            setTimeout(() => {
                // if (document.documentElement.scrollTop <= stockImagePosition - 20) {
                $(".Crypto2").css("display", "none");
                $(".Crypto2").removeClass("imageCryptoTable2");
            ...
            setTimeout(() => {
                ...
                $(".Crypto1").removeClass("imageCryptoTable1");
    ...
    //********************* */ third Animation *******************************
    {
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop <= User1ImagePosition - 50) {
                ...
                // $(".animatedTextUp").removeClass("css-typingremove");
                $(".out_image").removeClass("imageSupportLevelTablet")
                $(".out_image").removeClass("imageSupportLevelTablet1")
            ...
            if (document.documentElement.scrollTop >= User1ImagePosition) {
                ...
                $(".blackpic").addClass("imagerollingtablet")
                $(".blackpic").css("display", "block");
                // $(".graph").addClass("fade-out1");
                // $(".graph").addClass("graphImage1Tablet");
            ...
            if (document.documentElement.scrollTop >= User1ImagePosition + 100) {
                $(".out_image").addClass("imageSupportLevelTablet")
                ...
                setTimeout(() => {
                    ...
                    $(".UserOne").addClass("imageUserTablet1");
                    $(".arrowImage").addClass("imageArrowTable1");
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        $(".out_image").addClass("imageSupportLevelTablet1")
                    }, 500);
            ...
            //     // }, 1200);
            // }
            if (document.documentElement.scrollTop >= 1310) {
                $(".coursor").addClass(" scale-out-tr");
                $(".animateOut1").addClass("fade-out");
                $(".out_image").addClass("imageSupportLevelTablet2")
                $(".out_image").addClass("scale-in-hor-left")
            ...
            var User1ImagePosition = 1110
            if (document.documentElement.scrollTop <= User1ImagePosition - 20) {
            ...
            if (document.documentElement.scrollTop <= User1ImagePosition + 250) {
                $(".animatedTextUp").removeClass("fade-out");
                setTimeout(() => {
                    ...
                    $(".out_image").removeClass("imageSupportLevelTablet2")
            ...
            if (document.documentElement.scrollTop <= User1ImagePosition - 100) {
                ...
                $(".blackpic").css("display", "none");
                $(".blackpic").removeClass("imagerollingtablet")
                $(".out_image").removeClass("imagerollingtablet")
                // $(".graph").removeClass("graphImage1Tablet");
            ...
            if (document.documentElement.scrollTop <= User1ImagePosition - 200) {
                ...
                $(".UserOne").removeClass("imageUserTablet1");
                $(".arrowImage").removeClass("imageArrowTable1");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= User2ImagePosition) {
                ...
                $(".animatedTextUp").addClass("fade-out");
            }
            if (document.documentElement.scrollTop >= User2ImagePosition + 100) {
                $(".UserSecond").addClass("imageUserTablet2");
                ...
                $(".arrowImage2").addClass("imageArrowTable2");
            ...
            if (document.documentElement.scrollTop <= User2ImagePosition - 350) {
                $(".UserSecond").removeClass("imageUserTablet2");
                $(".arrowImage2").removeClass("imageArrowTable2");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= User3ImagePosition + 100) {
                $(".UserThird").addClass("imageUserTablet3");
                $(".arrowImage3").addClass("imageArrowTable3");
                ...
                setTimeout(() => {
                    $(".profitlevel1").addClass("imageprofitTablet1");
            ...
            if (document.documentElement.scrollTop >= User1ImagePosition + 550) {
                ...
                $(".textanimation3").addClass("css-typing1");
                $(".display3").css("display", "block");
                $(".graphImage2").addClass("graphImages2Tablet")
                $(".graphImage2").css("display", "block");
                setTimeout(() => {
                    $(".profitlevel1").addClass("imageprofitTablet3");
                }, 3300);
                $(".blackpic2").addClass("scale-out-hor-right")
                // $(".blackpic2").addClass("imagerolling2")
                $(".blackpic2").css("display", "block");                  


                $(".profitlevel1").addClass("imageprofitTablet2");
                // $(".yellowColor1").addClass("colorYellow");

                $(".yellowColor1").addClass("glow");
                $(".coursor2").addClass("cursorimage");
                $(".coursor2").addClass("  text-pop-up-bl");
                $(".arrowlines").addClass("arrowlineTablet");
            ...
            if (document.documentElement.scrollTop <= User2ImagePosition - 100) {
                $(".UserThird").removeClass("imageUserTablet3");
                $(".arrowImage3").removeClass("imageArrowTable3");
                ...
                $(".textanimation3").removeClass("css-typing1");
                $(".graphImage2").removeClass("graphImages2Tablet")
                $(".graphImage2").css("display", "none");
                $(".profitlevel1").removeClass("imageprofitTablet3");
                ...
                $(".arrowlines").removeClass("arrowlineTablet");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= graphLevel1Start) {
                ...
                // $(".graph1").addClass("graphlevel1Tablet");
                $(".graph1").css("display", "block");
                // $(".graphHideImage").addClass("Hidegraphlevel1");
                  $(".graphHideImage").css("display", "block");
            ...
            if (document.documentElement.scrollTop >= graphLevel1Start + 60) {
                ...
                $(".graphHideImage").css("display", "none");
                ...
                $(".graphSecondPart").css("display", "block");
                // $(".graphSecondPart").addClass("graphlevel1SecondPartTablet");

                $(".graphHideImageSecondPart").addClass("scale-out-hor-right-ForthGraph");
                $(".graphHideImageSecondPart").css("display", "block");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= graphLevel2Start) {
                $(".graphHideImageSecondPart").css("display", "none");
                ...
                $(".graph2").addClass("graphlevel2Tablet");
                $(".graphHideImage2").css("display", "block");
            ...
            if (document.documentElement.scrollTop >= graphLevel2Start + 60) {
                ...
                $(".graphHideImage2").css("display", "none");

                // $(".graphHideImage").removeClass("Hidegraphlevel1");
                $(".graph2SecondPart").css("display", "block");
                

                // $(".graph2SecondPart").addClass("graphlevel2SecondPartTablet");
                // $(".graphHideImage2SecondPart").addClass("Hidegraphlevel2SecondPart");
                $(".graphHideImage2SecondPart").css("display", "block");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= graphLevel3Start) {
                $(".graphHideImage2SecondPart").css("display", "none");
                ...
                $(".graph3").addClass("graphlevel3Tablet");
                // $(".graphHideImage3").addClass("Hidegraphlevel3");
                $(".graphHideImage3").css("display", "block");
            ...
            if (document.documentElement.scrollTop >= graphLevel3Start + 60) {
                $(".graphHideImage3").css("display", "none");
   
                // $(".graphHideImage3").removeClass("Hidegraphlevel3");

                // $(".graph3Seondpart").addClass("graphlevel3SecondPartTablet");
                $(".graph3Seondpart").css("display", "block");
     


                // $(".graphHideImage3SecondPart").addClass("Hidegraphlevel3SeondPart");
                $(".graphHideImage3SecondPart").css("display", "block");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= graphLevel4Start) {
                $(".graphHideImage3SecondPart").css("display", "none");
                ...
                $(".graph4").addClass("graphlevel4Tablet");
                $(".graphHideImage4").css("display", "block");
            ...
            if (document.documentElement.scrollTop >= graphLevel4Start + 60) {
                $(".graphHideImage4").css("display", "none");
    
                // $(".graphHideImage4").removeClass("Hidegraphlevel4");
               
                // $(".graph4SecondPart").addClass("graphlevel4SecondPartTablet");
                $(".graph4SecondPart").css("display", "block");
                   
                // $(".graphHideimage4SecondPart").addClass("Hidegraphlevel4SecondPart");
                $(".graphHideimage4SecondPart").css("display", "block");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= graphLevel5Start) {
                ...
                $(".graphHideimage4SecondPart").css("display", "none");
                ...
                $(".graph5").addClass("graphlevel5Tablet");
                // $(".graphHideImage5").addClass("Hidegraphlevel5");
                $(".graphHideImage5").css("display", "block");
            ...
            if (document.documentElement.scrollTop >= graphLevel5Start + 60) {
                ...
                $(".graphHideImage5").css("display", "none");
                $(".graph5SecondPart").css("display", "block");

                // $(".graph5SecondPart").addClass("graphlevel5SecondPartTablet");
                // $(".graphHideImage5SecondPart").addClass("Hidegraphlevel5SecondPart");
                $(".graphHideImage5SecondPart").css("display", "block");
        ...
        if (st > lastScrollTop) {
            ...
            if (document.documentElement.scrollTop >= FifthAnimation) {
                ...
                $(".buttonSizeAnimation").css("display", "block");
                $(".buttonSizeAnimation").addClass("text-focus-in-4animation");
                $(".buttonSizeAnimation").removeClass("fade-out");
                ...
                $(".ShowAnimation1").css("display", "block");
                $(".ShowAnimation2").css("display", "block");
                $(".ShowAnimation3").css("display", "block");
                $(".ShowAnimation4").css("display", "block");
            ...
            if (document.documentElement.scrollTop <= FifthAnimation) {
                $(".buttonSizeAnimation").removeClass("text-focus-in-4animation");
                $(".buttonSizeAnimation").addClass("fade-out");
